...
export class HttpService {
  constructor(private http: HttpClient, private router: Router, private cacheService: DataCacheService, private debugService: DebugService) {}

  private handleError(error: HttpErrorResponse, originalUrl?: string): Observable<never> {
    this.debugService.printConsole('HTTP Error:', error);
